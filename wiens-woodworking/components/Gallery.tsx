        ...
        <>
            ...
            {selectedImage && (
                ...
                >
                    ...
                    <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white text-sm bg-black/50 px-4 py-2 rounded flex flex-col items-center gap-1 pointer-events-none">
